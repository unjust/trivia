...
* Todo tu proyecto debe estar como entregable en un link funcional que nos permita ver tu código, puede ser el link de tu proyecto en linea ya sea  [Replit](https://repl.it), [Codepen](https://codepen.io/pen/) o [CodeSandbox](https://codesandbox.io/)
